...
def main():
    ...
    parser.add_argument("-v",
                        "--version",
                        help="Installed poretools version",
                        action="version",
                        version="%(prog)s " +
                        str(poretools.version.__version__))
    ...
    parser_combine = subparsers.add_parser(
        'combine', help='Combine a set of FAST5 files in a TAR achive')
    parser_combine.add_argument('files',
                                metavar='FILES',
                                nargs='+',
    ...
    parser_fastq = subparsers.add_parser(
        'fastq', help='Extract FASTQ sequences from a set of FAST5 files')
    parser_fastq.add_argument('files',
                              metavar='FILES',
                              nargs='+',
                              help='The input FAST5 files.')
    ...
    parser_fasta = subparsers.add_parser(
        'fasta', help='Extract FASTA sequences from a set of FAST5 files')
    parser_fasta.add_argument('files',
                              metavar='FILES',
                              nargs='+',
                              help='The input FAST5 files.')
    ...
    parser_stats = subparsers.add_parser(
        'stats', help='Get read size stats for a set of FAST5 files')
    parser_stats.add_argument('files',
                              metavar='FILES',
                              nargs='+',
                              help='The input FAST5 files.')
    ...
    parser_hist = subparsers.add_parser(
        'hist', help='Plot read size histogram for a set of FAST5 files')
    parser_hist.add_argument('files',
                             metavar='FILES',
                             nargs='+',
                             help='The input FAST5 files.')
    ...
    parser_events = subparsers.add_parser(
        'events', help='Extract each nanopore event for each read.')
    parser_events.add_argument('files',
                               metavar='FILES',
                               nargs='+',
                               help='The input FAST5 files.')
    ...
    # readstats
    ###########
    parser_readstats = subparsers.add_parser(
        'readstats',
        help='Extract signal information for each read over time.')
    parser_readstats.add_argument('files',
                                  metavar='FILES',
                                  nargs='+',
                                  help='The input FAST5 files.')
    ...
    # nucdist
    #########
    parser_nucdist = subparsers.add_parser(
        'nucdist', help='Get the nucl. composition of a set of FAST5 files')
    parser_nucdist.add_argument('files',
                                metavar='FILES',
                                nargs='+',
                                help='The input FAST5 files.')
    ...
    parser_metadata = subparsers.add_parser(
        'metadata',
        help=
        'Return run metadata such as ASIC ID and temperature from a set of FAST5 files'
    )
    parser_metadata.add_argument('files',
                                 metavar='FILES',
                                 nargs='+',
                                 help='The input FAST5 files.')
    ...
    parser_index.add_argument('files',
                              metavar='FILES',
                              nargs='+',
                              help='The input FAST5 files.')
    ...
    # qualdist
    ##########
    parser_qualdist = subparsers.add_parser(
        'qualdist',
        help='Get the qual score composition of a set of FAST5 files')
    parser_qualdist.add_argument('files',
                                 metavar='FILES',
                                 nargs='+',
                                 help='The input FAST5 files.')
    ...
    parser_qualpos.add_argument(
        ...
        default='all',
        help=
        'Which type of reads should be analyzed? Def.=all, choices=[all, fwd, rev, 2D, fwd,rev, best]'
    )
    parser_qualpos.add_argument(
        '--start',
        dest='start_time',
    ...
    parser_qualpos.add_argument(
        ...
        metavar='STRING',
        help=
        '''Save the plot to a file named filename.extension (e.g. pdf, jpg)''',
        default=None)

    ##########
    # winner
    ##########
    parser_winner = subparsers.add_parser(
        'winner', help='Get the longest read from a set of FAST5 files')
    parser_winner.add_argument('files',
                               metavar='FILES',
                               nargs='+',
                               help='The input FAST5 files.')
    parser_winner.add_argument(
        '--type',
        dest='type',
        metavar='STRING',
        choices=['all', 'fwd', 'rev', '2D', 'fwd,rev', 'best'],
    ...
    # squiggle
    ###########
    parser_squiggle = subparsers.add_parser(
        'squiggle', help='Plot the observed signals for FAST5 reads.')
    parser_squiggle.add_argument('files',
                                 metavar='FILES',
                                 nargs='+',
                                 help='The input FAST5 files.')
    ...
    parser_squiggle.add_argument(
        ...
        type=int,
        help=
        ('The number of plot facets (sub-plots). More is better for long reads. (def=6)'
         ))
    ...
    # times
    ##########
    parser_times = subparsers.add_parser(
        'times',
        help=
        'Return the start times from a set of FAST5 files in tabular format')
    parser_times.add_argument('files',
                              metavar='FILES',
                              nargs='+',
                              help='The input FAST5 files.')
    ...
    # yield_plot
    ############
    parser_yield_plot = subparsers.add_parser(
        'yield_plot', help='Plot the yield over time for a set of FAST5 files')
    parser_yield_plot.add_argument('files',
                                   metavar='FILES',
                                   nargs='+',
                                   help='The input FAST5 files.')
    parser_yield_plot.add_argument(
        '--saveas',
        dest='saveas',
        metavar='STRING',
    ...
    # yield_plot
    ############
    parser_occupancy = subparsers.add_parser(
        'occupancy',
        help='Inspect pore activity over time for a set of FAST5 files')
    parser_occupancy.add_argument('files',
                                  metavar='FILES',
                                  nargs='+',
                                  help='The input FAST5 files.')
    parser_occupancy.add_argument(
        '--saveas',
        dest='saveas',
        metavar='STRING',
        help='Save the plot to a file. Extension (.pdf or .png) drives type.',
    ...
    parser_organise = subparsers.add_parser(
        'organise', help='Move FAST5 files into a useful folder hierarchy')
    parser_organise.add_argument('files',
                                 metavar='FILES',
                                 nargs='+',
                                 help='The input FAST5 files.')
